...
This is an example to demonstrate how we can marshall and convert the rabbitMQ message string to domain object based on the binding key using MessageConverter
